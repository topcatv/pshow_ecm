...
public class DefaultContetntSchemaHolderTest extends SpringTransactionalTestCase {
	...
	@Test
	public void test() {
		List<TypeDef> type = csh.getAllContentType();
		assertNotNull(type);
		assertTrue(type.size() > 0);
		List<FacetDef> facet = csh.getAllFacet();
		assertNotNull(facet);
